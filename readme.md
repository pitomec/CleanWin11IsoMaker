...
> [!Important]
> I mainly use this branch by myself. The main differences with the default branch are the uninstallation of Edge, the disabling of Windows Defender and usage of Notepad++ instead of Default
<details>
